...
def write_report(path: Path, items: list[SoftItem], soft_tsv: Path, debug_jsonl: Path | None) -> None:
...
def main() -> int:
    ...
    write_report(report, items, soft_tsv, debug_jsonl if debug_rows else None)
