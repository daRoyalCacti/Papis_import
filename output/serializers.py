...
def record_to_result_dict(rec: Record) -> dict[str, str]:
    ...
    return {
        ...
        "Vision Used":       rec.debug.get("vision_used", "no"),
        "Vision Trigger":    rec.debug.get("vision_trigger", ""),
        "Vision Status":     rec.debug.get("vision_status", "not_attempted"),
        "Vision Error":      rec.debug.get("vision_error", ""),
